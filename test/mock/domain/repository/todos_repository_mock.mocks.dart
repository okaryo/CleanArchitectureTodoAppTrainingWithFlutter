...
import 'package:clean_architecture_todo_app/domain/model/state.dart' as _i2;
import 'package:clean_architecture_todo_app/domain/model/todo_id.dart' as _i6;
import 'package:clean_architecture_todo_app/domain/model/todo_list.dart' as _i3;
...
class _FakeState<T> extends _i1.Fake implements _i2.State<T> {}

class _FakeTodoList extends _i1.Fake implements _i3.TodoList {}
...
class MockTodosRepository extends _i1.Mock implements _i4.TodosRepository {
  ...
  @override
  _i5.Future<_i2.State<_i3.TodoList>> subscribe() => (super.noSuchMethod(
          Invocation.method(#subscribe, []),
          returnValue:
              Future<_i2.State<_i3.TodoList>>.value(_FakeState<_i3.TodoList>()))
      as _i5.Future<_i2.State<_i3.TodoList>>);
  @override
  _i5.Future<_i3.TodoList> getTodoList() =>
      (super.noSuchMethod(Invocation.method(#getTodoList, []),
              returnValue: Future<_i3.TodoList>.value(_FakeTodoList()))
          as _i5.Future<_i3.TodoList>);
  @override
  _i5.Future<void> createTodo(String? title, String? description,
